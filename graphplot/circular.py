...
def plot_connectivity_circle(
    ...
    print("con_val_scaled shape",con_val_scaled.shape)
    print("1 indices shape",indices)
    print("vmin",vmin)
    print("vmax",vmax)
    print("vrange",vrange)
